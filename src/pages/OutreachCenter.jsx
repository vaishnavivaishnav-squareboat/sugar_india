    ...
    <div className="p-6" style={{ backgroundColor: "#F8F9F6", minHeight: "100vh" }}>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="space-y-4 animate-fade-in animate-fade-in-delay-1">
            ...
            <div className="space-y-1 max-h-[320px] overflow-y-auto">
              {filteredLeads.slice(0, 30).map((lead, i) => (
                <button
                  ...
                  className={`w-full text-left p-2.5 rounded-lg border transition-all ${selectedLead?.id === lead.id ? "border-[#627F31] bg-[#627F31]/5" : "border-transparent hover:bg-[#F8F9F6]"}`}
                >
          ...
          {/* Selected Lead Info */}
          {selectedLead && (
            <div className="bg-[#627F31] text-white rounded-xl p-4 animate-fade-in" data-testid="selected-lead-info">
                  ...
                  <div className="flex gap-1.5 flex-shrink-0">
                    ...
                    {activeEmail.status === 'draft' && (
                      <button
                        ...
                        className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-md text-xs text-white bg-[#662B01] hover:opacity-90"
                      >
              ...
              <div className="space-y-2 max-h-[600px] overflow-y-auto">
                {emails.map((email, i) => (
                  <button
                    ...
                    className={`w-full text-left p-3 rounded-lg border transition-colors ${activeEmail?.id === email.id ? "border-[#627F31] bg-[#627F31]/5" : "border-[#F0F3EF] hover:bg-[#F8F9F6]"}`}
                  >
